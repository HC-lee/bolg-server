...
class MainSiteErrorController implements ErrorController {
    ...
    private static MainSiteErrorController MainSiteErrorController;
    ...
    public MainSiteErrorController() {
        if(MainSiteErrorController == null){
            MainSiteErrorController = new MainSiteErrorController(errorAttributes);
        }
    }
    ...
    private Map<String, Object> getErrorAttributes(HttpServletRequest request,
        ...
        map.put("URL", URL);
        logger.debug("MainSiteErrorController.method [error info]: status-" + map.get("status") +", request url-" + URL);
        return map;
    }
