...
public class AdminInterceptor implements HandlerInterceptor {
    ...
    private static final String[] IGNORE_URIS = {"/manage/login", "/manage/logout"};
        ...
        if (url.contains(AUTH_URIS)) {
            ...
            if (auth) {
                ...
                if (null == user) {
                    ...
                    out.print(mapper.writeValueAsString(ResultUtil.error(ErrorCodeEnum.NOT_LOGIN.getCode(), ErrorCodeEnum.NOT_LOGIN.getMsg())));
                    out.flush();
                    return false;
                }
            }
